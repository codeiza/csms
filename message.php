    ...
    <div class="dashboard-container">
        ...
        ?>
            ...
            <ul>
                ...
                <li>
                    <a href="schedule.php" class="dashboard-link"> <img src="image/dashboard.png" alt="Dashboard Logo"
                            class="dashboard-img">Home</a>
                </li>
                <li>
                    <a href="message.php" class="dashboard-link"><img src="image/chatbot.png" alt="chatbot Logo"
                            class="dashboard-img">Message<sup style="color:red; font-weight:bold" class="flashited"> New
                            <?php echo $totalmsg; ?></sup></a>
                </li>
            </ul>
            <?php
