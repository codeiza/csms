            ...
            <div class="dashboard-container">
                <div class="sidebar">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="message.php" class="dashboard-link"><img src="image/chatbot.png" alt="chatbot Logo" class="dashboard-img">Chatbot</a>
                        </li>
                    </ul>
                    <?php
                    ...
                    <div class="container py-5" id="page-container">
                        ...
                        if (isset($_SESSION['user'])) { ?>
                            ...
                            <div class="container py-5" id="page-container">
                                <div class="col-sm-12">
                                    <div class="form-box">
                                        <div class="form-title">MASS INTENTION REQUEST FORM <img src="image/logo.png" alt="Company Logo" width="50" height="50" style="float: right;">
                                        </div>
                                        <a href="services.php" class="btn btn-secondary mb-3"><i class="fas fa-arrow-left"></i> Back</a>
                                        <form method="post" action="php/insert_mass.php" enctype="multipart/form-data">
                                            <div>
                                                <div class="row">
                                                    <h4><b>Schedule Information:</b></h4>
                                                    <div class="col-sm-6">
                                                        <label for="fullname">Full Name:<span style="color:red"> *</span></label>
                                                        <input type="text" name="mass_name_person" required placeholder="Requester's Full Name (ex. Juan S. Cruz)" class="form-control" />
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="fullname">Email Address:<span style="color:red"> *</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <label for="sched_type">Select Event Type: <span style="color:red"> *</span></label>
                                                        <select id="sched_type" name="sched_type" class="form-control" required>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <label for="mass_type_of_mass">Type of Mass Intention Request <span style="color:red"> *</label>
                                                        <select id="mass_type_of_mass" name="mass_type_of_mass" class="form-control" required>
                                                            <option value="For Living Person">For Living Person</option>
                                                            <option value="For Sick Person">For Sick Person</option>
                                                            <option value="For Birthday">For Birthday</option>
                                                            <option value="For Anniversary">For Anniversary</option>
                                                            <option value="For Deceased Person">For Deceased Person</option>
                                                            <option value="Others">Others</option>
                                                        </select>
                                                    </div>

                                                    <div class="col-sm-3">
                                                        <label for="dateAndTime">Select Date & Time: <span style="color:red"> *</span></label>
                                                        <div id="availableSchedules"></div>
                                                        <input type="text" name="date_of_event" id="dateAndTime" required placeholder="Date & Time" class="form-control" />
                                                    </div>
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <label for="eventLocation">Mass Location: <span style="color:red"> *</span></label>
                                                        <input type="text" name="event_location" required placeholder="Mass Location (Full Address)" class="form-control" />
                                                    </div>

                                                    <div class="col-sm-6">
                                                        <label for="mass_type_of_mass">Name of Reserver: <span style="color:red"> * </label>
