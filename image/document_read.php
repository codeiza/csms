...
<div class="container">
  <table class="table table-striped table-condensed table-hover table-bordered" id="table">
    <thead id="fixed_header">
      <tr class="bg-success">
        <th class="head1">Document Owner</th>
        <th class="head1">Document Type</th>
        <th class="head1">Requested By</th>
        <th class="head1">Relation To The Owner</th>
        <th class="head1">Purpose</th>
        <th class="head1">Request Status</th>
        <th class="head1">Date Request</th>
        <th class="head1">Supporting Document</th>
