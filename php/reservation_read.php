...
try {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $tbody .= '<td class="editable" id="payment_type-'.$row["id"].'">'.$row["payment_type"].'</td>';
        $tbody .= '<td class="editable" id="amount_paid-'.$row["id"].'">'.$row["amount_paid"].'</td>';
...
<table class="table table-striped table-condensed table-hover table-bordered text-center">
    <thead class="btn-info">
        <tr>
            ...
            <th>Payment Type</th>
            <th>Amount Payment <br><span style="font-weight: normal;">(Note: For donations, amount payment is optional)</span></th>
...
<div class="col-sm-3 edited" style="display:none">
    <p>Baptismal <input name="bap" type="text" class="form-control edit_this" id="1" value="<?php echo $priceBaptismal ?>"></p>
    <p>Wedding <input name="wed" type="text" class="form-control edit_this" id="2" value="<?php echo $priceWedding ?>"></p>
    <p>Funeral <input name="funeral" type="text" class="form-control edit_this" id="3" value="<?php echo $priceFuneral ?>"></p>
    <p>Mass <input name="funeral" type="text" class="form-control edit_this" id="4" value="<?php echo $priceMass ?>"></p>
