    ...
    <div class="dashboard-container">
        <div class="sidebar">
            ...
            <div class="main-content">
                <div class="top-bar">
                    <div class="profile">
                        <span>History Transaction Monitoring</span>
                        <div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="keyword" class="form-control" placeholder="Search Keyword" aria-label="Search keyword">
                    </div>

                    <div class="col-sm-3">
                        <label for="payment" class="form-label">Filter Payment:</label>
                        <select class="form-select" id="payment" aria-label="Filter payment">
