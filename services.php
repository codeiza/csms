                ...
                <div class="container py-5" id="page-container">
                    ...
                    if (isset($_SESSION['user'])) { ?>
                        ...
                        <div class="container py-5" id="page-container">
                            <div class="col-sm-12">
                                <div class="form-box">
                                    <div class="form-title">EVENT SERVICES <img src="images/logo.png" alt="Company Logo" width="50" height="50" style="float: right;"> </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="baptism-wrapper">
                                                    <div class="baptism-container">
                                                        <div class="baptism-content">
                                                            <div class="baptism-icon">&nbsp;<img src="image/baptism.png" alt="Baptism Icon" style="width: 60px; height: 60px;"></div>
                                                            <div class="baptism-label"><b>&nbsp;&nbsp;&nbsp;&nbsp; BAPTISMAL</b></div>
                                                        </div>
                                                        <a href="client_dashboard.php" class="baptism-button">View Schedule</a>
                                                    </div>

                                                    <div class="baptism-container">
                                                        <div class="baptism-content">
                                                            <div class="baptism-icon">&nbsp;<img src="image/funeral.png" alt="Funeral Icon" style="width: 60px; height: 60px;"></div>
                                                            <div class="baptism-label"><b>&nbsp;&nbsp;&nbsp;&nbsp;FUNERAL</b></div>
                                                        </div>
                                                        <a href="client_dashboard.php" class="baptism-button"> View Schedule</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="baptism-wrapper">
                                                    <div class="baptism-container">
                                                        <div class="baptism-content">
                                                            <div class="baptism-icon">&nbsp;<img src="image/wedding.png" alt="Wedding Icon" style="width: 60px; height: 60px;"></div>
                                                            <div class="baptism-label"><b>&nbsp;&nbsp;&nbsp;&nbsp;WEDDING</b></div>
                                                        </div>
                                                        <a href="client_dashboard.php" class="baptism-button"> View Schedule</a>
                                                    </div>
                                                    ...
                                                    <div class="baptism-container">
                                                        <div class="baptism-content">
                                                            <div class="baptism-icon">&nbsp;<img src="image/mass.png" alt="Mass Icon" style="width: 60px; height: 60px;"></div>
                                                            <div class="baptism-label"><b>&nbsp;&nbsp;&nbsp;&nbsp; MASS</b></div>
                                                        </div>
                                                        <a href="mass.php" class="baptism-button"> View</a>
                                                    </div>
                                                </div>
