        ...
        <div class="dashboard-container">
            <div class="sidebar">
                ...
                <div class="main-content">
                    <div class="top-bar">
                        <div class="profile">
                            <span>Printing Of Certificate</span>
                            <div>
                    ...
                    <div class="container py-5" id="page-container">
                        <div class="row">
                            ...
                            <div class="col-sm-3 mb-3">
                                <div class="input-group">
                                    <label for="event_case" class="input-group-text">Filter:</label>
                                    <select class="form-select" id="event_case" aria-label="Filter by event case">
