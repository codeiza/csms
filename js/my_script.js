$(function(){
	...
	$(document).on('click','.requirment_wed',function(){
		//alert('');
			$(".modal-title").html('Please arrange your document accordingly')
			$(".modal-body-1").load('php/requirements_wedding.php')
			$("#confirmModal").modal('show')
		})
