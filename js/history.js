$(function(){
	...
	function load3(keyword,perpage,page,payment){
		$("#loading").html('<img src="img/loading.gif">');
		$.ajax({
			type: 'post',
			url: 'php/history_read.php',
			data:{
				keyword : keyword,
				perpage : perpage,
				page : page,
	...
	load3($("#keyword").val(),$("#perpage").val(),1,$("#payment").val())
 ...
 $(document).on('change','#perpage',function(){
	 load3($("#keyword").val(),$(this).val(),1,$("#payment").val())
	// load5($("#datefrom").val(),$(this).val(),1,$("#dateto").val())
	
 })
 	$(document).on('click','.page',function(){
		load3($("#keyword").val(),$("#perpage").val(),$(this).val(),$("#payment").val())
		
	})
 $(document).on('change','#payment',function(){
		load3($("#keyword").val(),$("#perpage").val(),1,$(this).val())
