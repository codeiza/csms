$(function(){
	...
	function load2(keyword,perpage,page){
		$("#loading").html('<img src="img/loading.gif">');
		$.ajax({
			type: 'post',
			url: 'php/mass_offering_read.php',
			data:{
				keyword : keyword,
				perpage : perpage,
				page : page
	...
	load2($("#keyword").val(),$("#perpage").val(),1)
 ...
 //alert($(this).attr('id'))
				...
				if(!confirm('Are you sure you want to disapproved?')){
					alert('No Changes');
					return false;
				}else{				
